  ...
  <div class="breakList">
   ...
   <el-tab-pane label="产品列表" name="first">
    ...
    <el-table :data="tables" style="width: 100%;margin-top:1rem;margin-bottom:1rem;" :header-cell-style="tableheader">
      ...
      <el-table-column prop="status" label="报损来源" width="130" :filters="[{ text: '出库', value: 2 }, { text: '入库', value: 1 },{ text: '装配', value: 3 }]"
...
<!--         <el-tag :type="scope.row.status=== 2 ? 'primary' : 'success'" disable-transitions>
          ...
          <el-tag
            :type="scope.row.source === 2 ? 'primary' : scope.row.source === 3 ? 'success' : scope.row.source === 1 ? 'info' : ''"
            close-transition>
            {{scope.row.source_}}
          </el-tag>
        </template>

    ...
    <el-form :inline="true"  :rules="rules" :model="formInline" ref="formInline" class="demo-form-inline">
      <div style="border-bottom:1px solid #e5e5e5;">
        <el-form-item label="报损编号" required prop="code">
          <el-input v-model="formInline.code" placeholder="报损编号"></el-input>
        </el-form-item>
        <el-form-item label="物品名称" required prop="name">
          <el-input v-model="formInline.name" placeholder="物品名称"></el-input>
        </el-form-item>
      </div>
      <div style="border-bottom:1px solid #e5e5e5;margin-top:1.375rem;">
        <el-form-item label="经办人" required prop="username">
          <el-input v-model="formInline.username" placeholder="经办人"></el-input>
        </el-form-item>
        <el-form-item label="报损部门" required prop="section">
          <el-select v-model="formInline.section" placeholder="报损部门">
        ...
        <el-form-item label="报损日期" required >
            ...
            <el-col :span="11">
              <el-form-item prop="date2">
                <el-time-picker placeholder="选择时间" v-model="formInline.date2" style="width: 100%;margin-left:10px;"></el-time-picker>
              </el-form-item>
            </el-col>
        </el-form-item>
      </div>
      <div style="border-bottom:1px solid #e5e5e5;margin-top:1.375rem;">
        <el-form-item label="报损原因" required prop="region">
          <el-select v-model="formInline.region" placeholder="报损原因">
      ...
      <div style="margin-top:1.375rem;">
        <el-form-item label="备注" required prop="desc">
          <el-input type="textarea" v-model="formInline.desc" style="width: 30rem;"></el-input>
        </el-form-item>
      </div>
    ...
    data() {
      return {
        formInline: {
          ...
          rules: {
                  code: [
                    { required: true, message: '请输入报损编号', trigger: 'blur' },
                    { min: 1, message: '长度至少一位', trigger: 'blur' }
                  ],
                  name: [
                    { required: true, message: '请输入报损名称', trigger: 'blur' }
                  ],
                  username: [
